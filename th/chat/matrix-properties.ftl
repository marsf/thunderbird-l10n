...
options-encryption-set-up-backup-and-cross-signing = เมื่อต้องการเปิดใช้งานการสำรองคีย์เข้ารหัสลับและการลงลายเซ็นข้ามใบรับรอง ให้ใส่วลีรหัสผ่านคีย์สำรองของคุณในแท็บ “ทั่วไป” หรือยืนยันข้อมูลประจำตัวของเซสชันใดเซสชันหนึ่งด้านล่างนี้
...
connection-error-session-ended = ออกจากเซสชันแล้ว
