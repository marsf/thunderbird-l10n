...
chat-encryption-sessions-description = Pro správné fungování koncového šifrování je potřeba ověřit relace v ostatních klientech přihlášených do vašeho účtu. Ověření relací může vést k tomu, že jim rovnou začne důvěřovat také { -brand-short-name }.
